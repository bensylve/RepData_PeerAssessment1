...
plot(weekendIntervalSummary$interval, weekdayIntervalSummary$avgSteps, type="l", xlab="Interval", ylab="Avg. Number of Steps", main="Average Number of Steps Per Interval")
```