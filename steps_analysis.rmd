...
# Read the csv data and store it as a table excluding the null values
...
# Get the max average number of steps per interval and use it to find the interval with the highest average
